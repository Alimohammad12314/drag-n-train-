...
#         target_select = document.getElementById("target-column")
...
#         console.log("Error during file upload:", str(e))
#     finally:
...
#         metrics_card.innerHTML = "<h3>Performance Metrics</h3>"
